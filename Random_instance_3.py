...
#Seed generation
Selected_instance=3
seed=1000*group_number+Selected_instance
print(f"seed={seed}")
...
Instance_3=np.column_stack((Supplier.round(0),p_i_new.round(2),y_i_new.round(2),c_i_new.round(1),c_i_eff_new.round(1),CR_i_new.round(2),Exp_R_i_new.round(2),Var_R_i_new.round(2)))
print(Instance_3)
